...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria retorner null quando único médico cadastrado não está disponível na data")
    void case01() {
        // Arrange
        ...
        // Act
        var medicoLivre = this.medicoRepository.escolherMedicoAleatorioLivreNadata(Especialidade.CARDIOLOGIA, proximaSegundaAs10);
        // Assert
